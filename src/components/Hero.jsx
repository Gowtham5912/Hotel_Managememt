...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover
     ...
     <h1 className="font-playfair text-2xl sm:text-4xl md:text-[56px]  sm:font-bold md:font-extrabold max-w-xl mt-4">
      ...
      <form className='bg-white text-gray-500 rounded-lg px-6 py-4  mt-8  flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
            ...
            <div>
                <div className='flex items-center gap-2'>
                    <img src={assets.calenderIcon} alr=" " className='h-4'/>
            ...
            <button className='flex items-center justify-center gap-1 rounded-md bg-black py-3 px-4 text-white my-auto cursor-pointer max-md:w-full max-md:py-1' >
                <img src={assets.searchIcon} alr="searchIcon" className='h-7'/>
                <span>Search</span>
            </button>
        </form>
    </div>
