...
const RoomDetails = () => {
  ...
  return room &&(
    <div className='py-28 md:py-35 px-4 md:px-16 1g:px-24 x1:px-32'>
        ...
        {/* Room Address */}
        <div className='flex items-center gap-1 text-grey-500 mt-2'>
        ...
        <div className='flex flex-col lg:flex-row mt-6 gap-6'> 
            ...
            <div className='grid grid-cols-2 gap-4 lg:w-1/2 w-full'>
                {room?.images.length > 1 && room.images.map((image, index)=>(
                    ...
                    className={`w-full rounded-xl shadow-md object-cover cursor-pointer ${mainImage === image &&  'outline3 outline-orange-500'}`}/>
                ))}
            </div>
        </div>
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                    {room.amenities.map((item, index)=>(
                        <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg bg-grey-100'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between 
                        bg-gray-50 shadow-lg p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-grey-500'>
        ...
        {/*Common Specification  */}
            ...
            <div className=' flex flex-col items-start gap-4'>
                <div className='flex gap-4'>
                    {/*<img src={room.hotel.owner.image} alt="Host" className="h-14 w-14 md:h-16 md:w-16 rounded-full object-cover"/>*/}
                    <div>
